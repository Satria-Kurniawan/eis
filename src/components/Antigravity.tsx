...
const AntigravityInner = ({
  ...
  useFrame(state => {
    ...
    particles.forEach((particle, i) => {
      ...
      let targetPos = { x: mx, y: my, z: Math.abs(mz * depthFactor) }; // Keep positive to avoid deep z hiding
  ...
  // Assign random colors natively to Instances
  useEffect(() => {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const color = new THREE.Color(randomColorStr);
