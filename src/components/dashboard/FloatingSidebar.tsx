...
export function FloatingSidebar() {
  ...
  return (
    <motion.div
      ...
      className="fixed left-4 top-32 bottom-8 z-100 flex flex-col rounded-3xl bg-white/40 dark:bg-[#14151a]/40 backdrop-blur-2xl border border-slate-200/50 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.12)] overflow-hidden"
      style={{
