      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-2">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground font-medium max-w-xl text-lg">
            Daftar mata kuliah yang ditawarkan untuk program studi pada periode ini.
          </p>
        </div>
        ...
        <div className="p-12 rounded-[2rem] border bg-card/40 backdrop-blur-sm shadow-sm border-primary/5 text-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">Data penawaran mata kuliah sedang disinkronkan dengan database kurikulum.</p>
            </div>
          </div>
        </div>
      </div>
