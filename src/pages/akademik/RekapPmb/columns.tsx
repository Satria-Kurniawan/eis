...
export const columns: ColumnRegular[] = [
  ...
  ...createCategoryColumns("smbjm_raport", "Raport"),
  ...createCategoryColumns("smbjm_talent", "Talent Scouting"),
  ...createCategoryColumns("smbjm_utbk", "UTBK"),
  ...createCategoryColumns("profesi", "Profesi"),
  ...createCategoryColumns("internasional", "Internasional"),
  ...createCategoryColumns("pasca", "Pascasarjana"),
  ...createCategoryColumns("adikpapua", "ADIK Papua"),
  {
    prop: "jumlah_peminat",
    name: "Total Peminat",
    size: 130,
