...
export function WisudaTable<TData, TValue>({
  columns,
  data,
  pageCount,
  pageIndex,
              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center justify-center space-y-4 opacity-30">
                    ...
                    <span className="text-xs font-black uppercase tracking-[0.2em] text-muted-foreground">Tidak Ada Data Wisudawan</span>
                  </div>
                </TableCell>
              </TableRow>
            )}
