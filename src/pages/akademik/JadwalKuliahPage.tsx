      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-2">
        <div className="space-y-3">
          <div className="flex items-center gap-2 text-primary font-bold text-xs uppercase tracking-[0.2em]">
            ...
            <span>Operasional Kuliah</span>
          </div>
          <h1 className="text-4xl font-black tracking-tighter text-foreground">
            Jadwal Kuliah
          </h1>
          <p className="text-muted-foreground font-medium max-w-xl text-lg">
            Pantau sebaran jadwal perkuliahan harian dan ketersediaan ruang kelas.
          </p>
        </div>
        ...
        <div className="p-12 rounded-[2rem] border bg-card/40 backdrop-blur-sm shadow-sm border-primary/5 text-center">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-muted-foreground">Sistem penjadwalan sedang dalam proses sinkronisasi data real-time.</p>
            </div>
          </div>
        </div>
      </div>
