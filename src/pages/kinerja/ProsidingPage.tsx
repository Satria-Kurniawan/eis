...
export default function ProsidingPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-2">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground font-medium max-w-xl text-lg">
            Pantau publikasi artikel pada prosiding seminar dan konferensi ilmiah nasional maupun internasional.
          </p>
        </div>
      ...
      {isError && (
        ...
        >
          <AlertTitle className="font-bold flex items-center gap-2">
            <AlertCircle className="size-4" /> Gagal Menarik Data Prosiding
          </AlertTitle>
          <AlertDescription>
      ...
      <ProsidingDetailModal
        data={selectedProsiding}
        isOpen={isModalOpen}
