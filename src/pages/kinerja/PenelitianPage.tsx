  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-2">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground font-medium max-w-xl text-lg">
            Pantau rekam jejak penelitian yang dilakukan oleh dosen.
          </p>
        </div>
      </div>
      ...
      <div className="bg-card/50 backdrop-blur-xl border border-primary/10 rounded-[2rem] p-12 flex flex-col items-center justify-center min-h-[400px] text-center space-y-4">
        ...
        <h2 className="text-2xl font-bold italic">Modul Penelitian Sedang Dalam Pengembangan</h2>
        <p className="text-muted-foreground max-w-md">
          Halaman ini akan segera tersedia dengan integrasi data hibah penelitian dan laporan akhir penelitian.
        </p>
      </div>
    </motion.div>
  );
